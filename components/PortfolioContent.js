            ...
            <Grid.Container  gap={2}>
                <Grid xs={12} sm={12} md={4}>
                    <Card isHoverable>
                        ...
                        <Card.Body>
                            <Col>
                                <Text weight="semibold">A web platform allowing users to track their crypto assets across multiple wallets, and chains. 3 clicks and you'll see everything in your wallets.
                                </Text>
                                <Image
                                    width={320}
                                    height={180}
                ...
                <Grid xs={12} sm={12} md={4}>
                    <Card isHoverable>
                        ...
                        <Card.Body>
                            <Col>
                                <Text weight="semibold">A No-Code Builder for Web3 Assets like tokens, and NFTS so that anyone can contribute to the ecosystem with their own ideas, no coding or signup required.
                                </Text>
                                <Image
                                    width={320}
                                    height={180}
            ...
            <Grid.Container gap={2}>
                <Grid xs={12} sm={12} md={4}>
                    <Card isHoverable>
                        ...
                        <Card.Body>
                            <Col>
                                <Text weight="semibold">A new ways for users to start building habits. This mobile app gamifies daily tasks or habits into quests for users to level up their IRL stats.
                                </Text>
                                <Image
                                    width={320}
                                    height={180}
                ...
                <Grid xs={12} sm={12} md={4}>
                    <Card isHoverable>
                        ...
                        <Card.Body>
                            <Col>
                                <Text weight="semibold">A Next-Gen TTS (Text-To-Speech) platform for converting text documents & files into audio for on-the-go use. 
                                </Text>
                                <Image
                                    width={320}
                                    height={180}
